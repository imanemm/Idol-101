...
def intro():
    ...
    school = "Star academy"
    print("You are a high school student in South Korea at ", school, ".")
    ...
    print("Will you succeed debuting? We wish you the best luck in your quest of becoming the next global star!")
    choice = input("Which path do you want to choose: ")
    return choice
